...
import org.entrystore.org.restlet.ext.jetty.internal.JettyClientCall;
import org.entrystore.org.restlet.ext.jetty.internal.RestletSslContextFactory;
    ...
    private HttpClient createHttpClient() {
        ...
        try {
            sslContextFactory = new RestletSslContextFactory(
                    SslUtils.getSslContextFactory(this));
        } catch (Exception e) {
            getLogger().log(Level.WARNING,
