...
import org.entrystore.rest.standalone.springboot.service.LoggingService;
...
public class ManagementController {
	...
	public ResponseEntity<Void> setLoggingConfig(
			@RequestBody SetLoggingConfigRequestBody body
	) {
