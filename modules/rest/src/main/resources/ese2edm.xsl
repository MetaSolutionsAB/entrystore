...
<xsl:stylesheet 
	...
	<xsl:template match="/">
		...
		<rdf:RDF>
	  	...
	  	<xsl:apply-templates select="srw:searchRetrieveResponse/srw:records/srw:record/srw:recordData/dc:dc" />
	...
	<xsl:template match="srw:searchRetrieveResponse/srw:records/srw:record/srw:recordData/dc:dc">
