...
class ZzzMultipartSizeLimitIT extends BaseSpec {
	...
	// absent). The "any 4xx makes this pass" concern from PR #264 review is addressed by the
	// under-cap/over-cap control pairing documented on SANITIZED_ERROR_MARKER.
