...
//		}
		...
		// update cached external metadata graph; a LocalMetadataWrapper shows the local metadata of the referenced
		// entry, which is not this entry's to change
		Model newCachedExternalMetadataGraph = null;
		if (getCachedExternalMetadata() instanceof MetadataImpl) {
